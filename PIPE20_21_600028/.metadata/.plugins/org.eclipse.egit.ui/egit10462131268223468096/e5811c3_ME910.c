...
typedef enum {
    ...
    M_ECHO_OFF, M_BAND, M_CGMR, M_CPU_MODE, M_CMEE, M_CEMODE, M_CCIOTOPT, M_IMEI, M_PIN, M_CCID, M_CIMI, M_CFUN, M_WS46IOT, M_WS46,  M_GPIO_1, M_GPIO, M_SLED, M_SKIPESC, M_CGATT_0, M_CGATT_1, M_CGDCONT_1, M_COPS, M_CSQ, M_CEREG,	// Conexion 4G
...
#ifdef HTTPS
	"AT#SSLCFG=1,1,1500,0,100,10,1,0,0,0\r",//"AT#SSLCFG=1,1,1500,0,100,10,0,0,1,0,1200,0\r",
	"AT#SSLCFG=1,1,1500,0,100,10,1,0,0,0\r",//"AT#SSLCFG=1,1,1500,0,100,10,0,0,1,0,1200,0\r",
#else
...
#endif
	"AT#SSLSECCFG=1,0x9F,0\r",			/**< SSLSECCFG - 30 */		//"AT#SSLSECCFG=1,0,0\r",
	"AT#SSLEN=1,0\r",				/**< SSLDIS - 31 */
	"AT#SSLEN=1,1\r",				/**< SSLEN - 31 */
#ifdef HTTPS
	"AT#CCLKMODE=1\r",//"AT#SSLSECCFG2=1,4,1,0,2\r",
#else
...
static char *   __searchPLMNbyAPN( uint8_t apn );
////////////////////////////////////////////////////////////////////////////////
// Enable 4V_NB
...
//static char *__searchPLMNbyAPN( uint8_t apn_index )
//{
//	uint32_t index = 0;
...
//    	return 1;
//	}
	if (( 1 == params_get_mqtt_dc_on() ) && ( 1 == mqtt_timer_get_idle_mode() )  && ( 0 == mbus_get_start_comm() ))
	{
		return 0;
	}
#endif
