...
struct params
{
    ...
    uint32_t over_sensor_alarm[NUM_INPUTS_SENSOR];
    uint32_t low_sensor_alarm[NUM_INPUTS_SENSOR];
    uint32_t oversensor_condition;
    uint32_t lowsensor_condition;

#if defined(UNE82326)
    uint32_t gap[1828 - 3 - 12/4 - 4/4 - 4/4*READ_WINDOWS - 1*SEND_WINDOWS - 1 - 1*SEND_WINDOWS - 1*SEND_WINDOWS - 1*SEND_WINDOWS - 1 - 3 - 4 - 1*SEND_WINDOWS - 1*SEND_WINDOWS - 12/4 - 1 - 3 - 54 - 1 - 4 - 3 - 1 - 2 - 3 - 1 - 3 - 1 - 20 - 1 - 5 - 1 - 1 - 1 - 2 - 1 - 2 - 2 - 1 - 2 - 4 - 4 - 1 - 1];/*2048/4 - 1 - 7 - 452/4 - (96/4 + 3)*2 - 34 - 6 - 1 - IMEI_NAME_LEN/4*/
#elif defined(MBUS)
    uint32_t gap[1828 - 3 - 12/4 - 4/4 - 4/4*READ_WINDOWS - 1*SEND_WINDOWS - 1 - 1*SEND_WINDOWS - 1*SEND_WINDOWS - 1*SEND_WINDOWS - 3 - 5 - 1 - 3 - 4 - 1*SEND_WINDOWS - 1*SEND_WINDOWS - 12/4 - 1 - 3 - 54 - 1 - 4 - 3 - 1 - 2 - 3 - 1 - 3 - 1 - 20 - 1 - 5 - 1 - 1 - 1 - 2 - 1 - 2 - 2 - 1 - 2 - 4 - 4 - 1 - 1];/*2048/4 - 1 - 7 - 452/4 - (96/4 + 3)*2 - 34 - 6 - 1 - IMEI_NAME_LEN/4*/
#endif
    uint32_t crc;
...
uint8_t 	 params_psm_edrx_tt3412( void );
uint8_t 	 params_psm_edrx_tt3324( void );
uint8_t 	 params_psm_edrx_edrx( void );
void         params_psm_edrx_set_tt3412( uint8_t _tt3412 );
void 		 params_psm_edrx_set_tt3324( uint8_t _tt3324 );
...
uint32_t     params_get_over_sensor_alarm(uint8_t num);
void         params_set_over_sensor_alarm(uint8_t num, uint32_t _over_sensor);
uint32_t     params_get_low_sensor_alarm(uint8_t num);
