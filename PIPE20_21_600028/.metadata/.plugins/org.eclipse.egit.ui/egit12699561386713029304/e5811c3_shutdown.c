...
//		HAL_RCCEx_DisableLSECSS();
	...
	HAL_PWR_DisableWakeUpPin(PWR_WAKEUP_PIN7_HIGH_1);
	HAL_PWR_DisableWakeUpPin(PWR_WAKEUP_PIN8_HIGH_1);
...
#endif
//		HAL_PWR_EnableWakeUpPin(PWR_WAKEUP_PIN7_HIGH_3|PWR_WAKEUP_PIN2_HIGH_1|PWR_WAKEUP_PIN1_HIGH_0|PWR_WAKEUP_PIN7_HIGH_1|PWR_WAKEUP_PIN8_HIGH_1);
...
//		HAL_PWR_EnableWakeUpPin(PWR_WAKEUP_PIN7_HIGH_3|PWR_WAKEUP_PIN2_HIGH_1|PWR_WAKEUP_PIN1_HIGH_0);
		HAL_PWR_EnableWakeUpPin(PWR_WAKEUP_PIN7_HIGH_3);
		HAL_PWR_EnableWakeUpPin(PWR_WAKEUP_PIN2_HIGH_1);
		HAL_PWR_EnableWakeUpPin(PWR_WAKEUP_PIN1_HIGH_0);
//#endif
	...
	if ((0 == alarms_sensor_check) && (1 == Tick_cloud_time_init()))
	{
		...
		for (i = 0; i < NUM_INPUTS_SENSOR; i++ )
		{
			if (1 == generic_sensor_get_end_conv(i))
			{
				...
				{
					if (generic_sensor_alarm_counter++ > 2)
					{
...
static void __DlmsSchedule( int32_t  minute_factor_dlms, uint32_t _shutdown_time_periodic_mode )
{
	...
	if (( 0 == rest_upgrading_firmware() ) &&  (1 == Tick_cloud_time_init()) )
	{
